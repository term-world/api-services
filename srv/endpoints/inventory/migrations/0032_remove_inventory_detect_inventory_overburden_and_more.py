...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('inventory', '0031_remove_inventory_detect_inventory_overburden_and_more'),
    ]
